...
func navigationStyle() templ.CSSClass {
	var templ_7745c5c3_CSSBuilder strings.Builder
	templ_7745c5c3_CSSBuilder.WriteString(`min-width:240px;`)
	templ_7745c5c3_CSSID := templ.CSSID(`navigationStyle`, templ_7745c5c3_CSSBuilder.String())
...
func navigationItem(args NavigationItemArgs) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 = []any{"nav-link", templ.KV("active", args.active)}
		...
		var templ_7745c5c3_Var3 templ.SafeURL = templ.SafeURL(args.href)
		...
		var templ_7745c5c3_Var4 string = args.label
...
func sidebar() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var6 = []any{"navbar bg-dark justify-content-start align-items-start"}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" data-bs-theme=\"dark\"><div class=\"container-fluid flex-column justify-content-start align-items-start\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func Navigation(args NavigationArgs) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		templ_7745c5c3_Buffer, templ_7745c5c3_IsBuffer := templ_7745c5c3_W.(*bytes.Buffer)
		if !templ_7745c5c3_IsBuffer {
			templ_7745c5c3_Buffer = templ.GetBuffer()
		...
		templ_7745c5c3_Var8 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			var templ_7745c5c3_Var9 = []any{navigationStyle(), "navbar-nav nav-pills flex-column mb-auto"}
			...
			templ_7745c5c3_Err = navigationItem(NavigationItemArgs{
				label:  "Active",
				href:   "#",
		...
		templ_7745c5c3_Err = sidebar().Render(templ.WithChildren(ctx, templ_7745c5c3_Var8), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
